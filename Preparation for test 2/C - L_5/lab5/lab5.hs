...
isBloodOrange fruit = case fruit of Orange variety segments -> elem variety tr
                                    _ -> False

-- 2.
bloodOrangeSegments :: [Fruit] -> Int
bloodOrangeSegments (fruit@(Orange variety segments):xs) | isBloodOrange fruit = segments + bloodOrangeSegments xs
                                                       | otherwise = bloodOrangeSegments xs
bloodOrangeSegments (fruit@(Apple variety hasWorm):xs) = bloodOrangeSegments xs
bloodOrangeSegments [] = 0

-- 3.
worms :: [Fruit] -> Int
worms (fruit@(Apple variety hasWorm):xs) | hasWorm = 1 + worms xs
                                         | otherwise = worms xs
worms (fruit@(Orange variety segments):xs) = worms xs
worms [] = 0
